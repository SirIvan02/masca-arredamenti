    ...
    <>
      <Parallax src={HERO_IMAGE} alt="" strength={14} className="h-[100svh] min-h-[540px]">
        ...
        <div className="pointer-events-none absolute inset-x-5 bottom-8 text-cream min-[640px]:inset-x-[30px] min-[640px]:bottom-[58px]">
          <motion.p
            ...
            className="mb-3.5 max-w-[22em] text-[11.5px] min-[640px]:text-[11px] uppercase leading-[1.5] tracking-[0.22em] opacity-75 min-[640px]:mb-5 min-[640px]:tracking-[0.32em]"
          >
          ...
          <motion.h1
            ...
            className="max-w-[15em] font-serif text-[clamp(43px,8.4vw,120px)] leading-[0.98] tracking-[-0.02em] text-balance min-[640px]:leading-[0.95]"
          >
          ...
          >
            <p className="max-w-[34em] text-[17px] min-[640px]:text-[16px] leading-[1.65] opacity-85 text-pretty min-[640px]:leading-[1.7]">
              {t(
            ...
            <span className="hidden text-[12px] min-[640px]:text-[11px] uppercase tracking-[0.3em] opacity-60 min-[640px]:inline">{t('Scorri', 'Scroll')}</span>
          </motion.div>
        </div>
      </Parallax>
      ...
      <section className="mx-auto max-w-[1440px] px-5 py-[clamp(56px,9vw,130px)] min-[640px]:px-[30px]">
        <div className="grid items-start gap-[clamp(30px,5vw,80px)] [grid-template-columns:repeat(auto-fit,minmax(min(100%,300px),1fr))]">
          <Reveal as="h2" className="font-serif text-[clamp(31px,3.6vw,56px)] leading-[1.08] tracking-[-0.015em] text-balance">
            {t('Tre generazioni in laboratorio, un progetto alla volta.', 'Three generations in the workshop, one project at a time.')}
          </Reveal>
          <Reveal className="flex max-w-[40em] flex-col gap-4.5 text-[17px] min-[640px]:text-[16px] leading-[1.75] text-body">
            <p>
              {t(
            ...
            <Link to="/chi-siamo" className="self-start border-b border-[#C9BFAB] pb-1.5 text-[12px] min-[640px]:text-[11px] uppercase tracking-[0.2em] hover:border-brass hover:text-brass">
      ...
      <section className="mx-auto max-w-[1600px] px-5 pb-[clamp(56px,9vw,130px)] min-[640px]:px-[30px]">
        ...
        <div className="mt-9 flex justify-center min-[640px]:mt-11">
          <Link
            to="/realizzazioni"
            className="rounded-full border border-ink px-[30px] py-[15px] text-[12px] min-[640px]:text-[11px] font-medium uppercase tracking-[0.2em] text-ink transition-colors hover:bg-ink hover:text-cream active:bg-ink active:text-cream"
          >
      ...
      <section className="bg-ink px-5 py-[clamp(56px,9vw,130px)] text-cream min-[640px]:px-[30px]">
        <Reveal as="blockquote" className="mx-auto max-w-[1100px] font-serif text-[clamp(27px,3.4vw,54px)] leading-[1.25] tracking-[-0.01em] text-balance min-[640px]:leading-[1.2]">
          {t(
