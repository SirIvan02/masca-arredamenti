...
export default function Offers() {
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-[30px] pb-[clamp(70px,9vw,130px)] pt-[calc(clamp(70px,9vw,130px)+60px)]">
      ...
      <Reveal as="h1" className="max-w-[16em] font-serif text-[clamp(41px,5.2vw,84px)] leading-none tracking-[-0.02em] text-balance">
        {t('Pezzi del laboratorio, pronti da ritirare', 'Pieces from the workshop, ready to go')}
      </Reveal>
      <Reveal as="p" className="mt-6.5 max-w-[36em] text-[17px] min-[640px]:text-[16px] leading-[1.75] text-body">
        {t(
        ...
        {OFFERS.map((o) => (
          <div key={o.it} className="bg-cream p-4">
            ...
            <div className="px-1 pb-1 pt-4">
              ...
              <p className="mt-1.5 text-[14px] min-[640px]:text-[13px] text-muted">{t('Un pezzo disponibile', 'One piece available')}</p>
            </div>
          </div>
        ))}
      </Reveal>
      ...
      <div className="mt-11 flex justify-center">
        <Link
          to="/contatti"
          className="rounded-full border border-ink px-[30px] py-[15px] text-[12px] min-[640px]:text-[11px] font-medium uppercase tracking-[0.2em] text-ink transition-colors hover:border-brass hover:text-brass active:border-brass active:text-brass"
        >
