...
export default function Footer() {
  const { t } = useLang();
  return (
    <footer className="border-t border-cream/10 bg-ink px-[30px] py-[34px] text-[12px] leading-[1.8] text-cream/60">
      ...
      <p className="mt-[30px] flex items-center justify-center gap-[11px] text-[10px] uppercase tracking-[0.22em] text-cream/35">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="font-serif text-[15px] normal-case tracking-[0.04em] text-cream/70 transition-colors hover:text-brass-light"
        >
          {CREDIT.name}
        </a>
        <span className="h-px w-[26px] bg-cream/20" />
